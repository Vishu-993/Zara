...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            btn = [[
                InlineKeyboardButton(text=f"🔍 Search Here 🔎", url=f"https://telegram.me/+Y73zxs1kUlIwZmM1")
            ],[
        ...
        try:
            btn = [[
                InlineKeyboardButton(text=f"🔍 Search Here 🔎", url=f"https://t.me/+Y73zxs1kUlIwZmM1")
            ],[
                InlineKeyboardButton(text=f"🐞 REPORT ISSUE 🐞", url=f"https://t.me/+9Y0zeiIAFeczMDJl")
            ],[
                InlineKeyboardButton(text=f"🦋 FOLLOW US 🦋", url=f"https://bit.ly/3FJVSPA")
